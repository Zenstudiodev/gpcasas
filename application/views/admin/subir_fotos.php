...
<?php $this->start('css_p') ?>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>/ui/vendor/materialize/materialize.min.css"/>
<?php $this->stop() ?>
...
<?php $this->start('js_p') ?>
    <!-- Materialize js -->
    <script type="text/javascript" src="<?php echo base_url(); ?>/ui/vendor/materialize/materialize.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>/ui/vendor/cropperjs/cropper.min.js"></script>
    <script>
